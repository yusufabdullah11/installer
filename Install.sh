...
echo -b "AUTHOR    : kabelsata $green " |lolcat
echo -b "NOTES     : budaya membaca file Readme.md untuk menjalankan script " | lolcat
echo -b "_____________________________________________________________" | lolcat
...
sleep 1
echo -b $green"[#]> kabelsata On Your System" |lolcat

echo -b $green"[#]> See you Again By Kabelsata :)..." |lolcat
figlet Kabel_sata™✓ | lolcat
sleep 1
exit
}
...
echo -e "============================" | lolcat
cho -e $b "145. Install Termux-Lazsqlmap${enda}";
echo -e "============================" | lolcat
